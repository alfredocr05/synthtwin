...
- **Checking a file costs more.** The checker now has tails to check:
  20,000 rows by 20 columns take 90.5 s against 70.2 s before stage 3,
  measured quiet (`K-P3-12`). Building a twin costs nothing extra
