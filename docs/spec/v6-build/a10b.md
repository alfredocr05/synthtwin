## 10. The version rule, the refusal catalogue, and the message

### 10.1 The version rule, and what it binds
...
**C6-44 binds the catalogue.** The two version rows below, R11 and R12,
...
### 10.2 The two version rows, and why their advice differs
...
### 10.4 The older-version message, word for word
