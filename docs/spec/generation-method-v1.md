...
### G5.1a The tail block (stage 3, plans P4-D321 to P4-D327)
...
### G5.3b The tail reading (stage 3, plans P4-D321, P4-D322)
...
**Why each step** (measured on the 16-shape battery of plan P4-D321 at
...
* `tails.<key>.<key>` — one distance of one tail (stage 3, contract
  6.7a): the first `<key>` is `low` or `high` and the second is
...
### G12.13 The window on the tail facts (stage 3, plan P4-D321)
...
ELEVENTH FILES** (landing 3.3, plans P4-D321 to P4-D327). Every column
...
`tests/reference/generation-branch-vectors-9.json`, holds three
