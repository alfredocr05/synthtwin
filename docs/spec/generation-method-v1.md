...
`tests/reference/generation-branch-vectors-3.json` carries the five the
repair of the final Codex review of the number censuses added (plans
P4-D142, P4-D145 and P4-D147), through the entry point
