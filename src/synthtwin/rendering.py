...
def _formula_lines(
    ...
    return lines + [
        ...
        "holding. Where synthtwin invented it, your description's counts",
        "left it no spelling of that width without one -- your own table",
        "had values written that way, which is what those counts say.",
