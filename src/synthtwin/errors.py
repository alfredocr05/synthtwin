...
def profile_version_is_older(found: int, reads: int) -> str:
    ...
    * `--keep-value`. Sixty readings and twelve cells holding a word,
    ...
    return (
        ...
        f"--first-row and --day-first. Every one of them changes what the "
        ...
        f"slashed dates can be read the other way round, which changes "
        f"the dates the description publishes and can leave the column "
        f"described as text instead. Read the summary page synthtwin writes "
