...
def profile_version_is_older(found: int, reads: int) -> str:
    ...
    * `--keep-value`. Sixty readings and twelve cells holding a word,
    ...
    return (
        ...
        f"--smallest-group, --first-row and --day-first. Every one of "
        f"them changes what the "
        ...
        f"described like any other column; without the --code you gave, a column of codes is described as measurements, so its smallest and largest values \u2014 which are real codes \u2014 are published and its twin loses any leading zeros; without the --missing-value "
