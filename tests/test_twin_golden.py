...
# MOVED AT THE TAIL LANDING (stage 3, plan P4-D328), and all four
# digests move together because the FIRST of them did: the producer
# publishes tails in place of the two ends on every column of dates and
# clock times, so the twin and both reports were built from different
# bytes. The producer's own change is read in the profile golden of
# tests/test_profile_document.py. Checked before re-recording: the
# demonstration's twin and its own table both validate with nothing
# missed, no line of either report prints one of the eleven outermost
# values of any column, and the new report carries a tail sentence per
# date column where it carried an earliest-and-latest line.
GOLDEN_DESCRIPTION_SHA256 = (
    "9c0e3677251d28624b85ebbce5e281b0d7ceb26ba0172f7c98b2c68f03b44e7f"
)
...
GOLDEN_REPORT_SHA256 = (
    ...
    "eee118d1620e94a9dff903b9d2e676873f6bdaac52f52f7de62b950c5e3beeac"
)
