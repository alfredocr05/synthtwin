...
PLAN4_REGIONS = {
    ...
    "tails": "### P4-D321 The numeric tail (landing 3.3)",
...
REGISTRY += [
    ...
    # P4-D321). They stay EXACT-OBSERVABLE, and a tail block publishes
...
REGISTRY += [
    ...
    # THE TAIL FACTS (stage 3, plan P4-D321, contract 6.7a). The two
