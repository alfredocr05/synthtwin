...
_BATTERY: "dict[str, str | bytes]" = {
    ...
    # Refused at that row until plan P4-D86; the reader now names such a
    ...
    # and since plan P4-D86 a file doing that consistently is read; a
...
def test_the_named_routes(
    ...
    * the positions of a repeated name was the first of them, and it
      closed with plan P4-D86: the profiler no longer refuses a repeated
...
def test_a_blank_or_repeated_name_is_read_and_its_header_misses(
    ...
    """What stands where the two header-refusal tests stood (plan P4-D86).
