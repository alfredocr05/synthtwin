...
# -- P4-D93: a class arrangement may not strand a feasible form debt --
...
# -- P4-D94: a form reads as a number where its exponent filling does --
...
def test_an_anchored_exponent_form_is_settled_inside_the_published_ends(
    ...
    """P4-D92 BOUNDS P4-D94 without withdrawing it.
...
def test_a_leading_plus_or_a_grouping_mark_is_still_carried() -> None:
    ...
    Their cause is not P4-D94's: `+00` and `0,000` already read as
