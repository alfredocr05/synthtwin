...
| `kpi_decontamination.py` | K-P0-05: the decontamination scan COMPLETES a read of at least 400 files, over at least 400 text surfaces, and finds nothing, so a scan of no file cannot pass -- the count is instrumented at the surface reader the scan pulls its text through, never taken from the listing |
