...
| `kpi_stage3_tail_leak.py` | K-S3-01: published values, summary lines and report lines equal to one of the eleven outermost values of a date or clock column, and the tails the published facts settle by back-solve, over the tail design's own battery |
